...
ggplot(data=dat[ranzoniCT.v=='MPP',],aes(x=Celltype,y=MEMP_pr,fill=Celltype))+
  geom_boxplot()+
...
# define primed MEMPs for scATAC-Seq data
...
# define primed GPs for scATAC-Seq data
...
# exclude overlapping primed cells
...
print(paste0('Number of primed MEMPs=',length(atac.MEMP.prime.cell.v)))
print(paste0('Number of primed GPs=',length(atac.GP.prime.cell.v)))
